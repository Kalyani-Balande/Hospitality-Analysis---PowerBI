...
## 1. Project Title / Headline
   Hospitality Analysis: A dynamic, interactive data visualization tool built to analyze hospitality data for Atliq Grands.
...
## 4. 📂Data Sources
CSV files provided by Atliq Grands Management.
## 5. Learnt things from this Project
...
## 6. 🚀Some Important insights from the Dashboard
